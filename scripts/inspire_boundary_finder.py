...
Usage:
    python scripts/inspire_boundary_finder.py --lat 51.268535 --lon -0.570979
    python scripts/inspire_boundary_finder.py --lat 51.268535 --lon -0.570979 --gml data/inspires/Adur_District_Council.gml
"""
...
Examples:
  python scripts/inspire_boundary_finder.py --lat 51.268535 --lon -0.570979
  python scripts/inspire_boundary_finder.py --lat 51.268535 --lon -0.570979 --gml data/inspires/Adur_District_Council.gml
  python scripts/inspire_boundary_finder.py --lat 51.268535 --lon -0.570979 --buffer 10
        """
    )
