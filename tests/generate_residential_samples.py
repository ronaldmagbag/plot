...
Usage:
    python tests/generate_residential_samples.py
    python tests/generate_residential_samples.py --output ./output_residential
"""
...
# Add src to path
# __file__ is at tests/generate_residential_samples.py, so go up one level to project root
...
Examples:
  ...
  Custom output directory:
    python tests/generate_residential_samples.py --output ./my_plots
  
  Faster generation (lower delay):
    python tests/generate_residential_samples.py --delay 2.0
        """
    )
